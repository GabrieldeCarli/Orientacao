 ...
 * @author Caroline
 */
@WebServlet(urlPatterns = {"/buscar-orientacao"})
public class BuscarOrientacaoController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (request.getParameter("tema") != null && request.getParameter("aluno") != null && request.getParameter("professor") != null) {
            ...
            request.setAttribute("orientacoes", con.buscaOrientacao(request.getParameter("aluno"), request.getParameter("professor"), request.getParameter("tema")));
        }
